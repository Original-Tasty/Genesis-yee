...
### Dependencies + git clone on Ubuntu 18.04
    ...
    apt-get update && apt-get upgrade -y && apt-get update && apt install python3-pip -y && apt install python-pip -y && apt-get install libssl-dev && pip install scrypt construct==2.5.2 && git clone https://github.com/gnark-mining/GenesisH0.git genesis && cd genesis && clear
