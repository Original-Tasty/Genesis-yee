...
### Dependencies apt install python-pip

    apt-get install libssl-dev -y && apt install python-pip -y && pip install 'requests[security]'  && pip install scrypt construct==2.5.2
